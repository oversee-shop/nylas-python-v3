...
from nylas_v3.models.response import ListResponse, Response, DeleteResponse
from nylas_v3.models.threads import ListThreadsQueryParams, Thread, UpdateThreadRequest
